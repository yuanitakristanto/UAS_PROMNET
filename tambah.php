			...
			<div class="item form-group">
				...
				<div class="col-md-6 col-sm-6">
					<select name="Program_Studi" class="form-control" required>
						...
						<option value="Teknik SipilL">Teknik Mesin</option>
						<option value="Teknik Kimia">Teknik Elektro</option>
						<option value="Teknik Elektro">Fisika</option>
						<option value="Akuntansi">Akuntansi</option>
						<option value="Manajemen">Manajemen</option>
						<option value="Farmasi">Psikologi</option>
						<option value="Hukum">Ekonomi Pembangunan</option>
						<option value="Kedokteran">Ilmu Komunikasi</option>
					</select>
				</div>
			</div>
			<div class="item form-group">
