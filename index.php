...
<html lang="en">
  <head>
	...
	<link rel="icon" href="assets/images/uniga.png" type="image/ico" />

    <title> Data Mahasiswa UNIGA Malang </title>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" >
                  <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="assets/images/foto.jpg" alt="">Yuanita Kristanto
                  </a>
      ...
      switch ($queries['page']) {
        ...
        <footer>
          <div class="pull-right">
            Copyright @ 2021 Data Mahasiswa : Yuanita Kristanto
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
